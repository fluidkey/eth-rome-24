...
contract BorrowOfframpExecutorModule is ERC7579ExecutorBase {
    ...
    //////////////////////////////////////////////////////////////////////////*/
    // AAVE pools on Base
    AaveV3Pool public constant AAVE_V3_POOL = AaveV3Pool(0xA238Dd80C259a72e81d7e4664a9801593F98d1c5);
    WETHGateway public constant WETH_GATEWAY =
        WETHGateway(0x8be473dCfA93132658821E67CbEB684ec8Ea2E74);
    AaveOracle public constant AAVE_ORACLE = AaveOracle(0x2Cc0Fc26eD4563A5ce5e8bdcfe1A2878676Ae156);
    ...
    ERC20 public USDC = ERC20(0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913); // USDC on Base
    ...
    /**
     * Supply and borrow within the same transaction, send the borrowed funds to an authorized
     * withdrawal address.
     ...
     */
    function borrow(address safe) external {
        ...
        success = safeInstance.execTransactionFromModule(
            ...
            abi.encodeWithSignature(
                "depositETH(address,address,uint16)", address(AAVE_V3_POOL), safe, 0
            ),
            0
        );
        require(success, "ETH deposit failed");

        uint256 safeBorrowAmountInUsdc = _evalSafeUsdcBorrowAmount(ethBalance);
        ...
        success = safeInstance.execTransactionFromModule(
            ...
            0,
            abi.encodeWithSignature(
                "transfer(address,uint256)", withdrawalAddress, safeBorrowAmountInUsdc
            ),
            0
        );
    ...
    function repay(address safe) external {
        //        IERC7579Account(msg.sender).executeFromExecutor(ModeLib.encodeSimpleSingle(),
        // data);
        // check that the module is installed and _initialized
        require(_initialized[safe], "Module not initialized");
        ...
        ERC20 aArbWETH = ERC20(0xD4a0e0b9149BCee3C920d2E00b5dE09138fd8bb7);
    ...
    function _evalSafeUsdcBorrowAmount(uint256 ethBalance) internal view returns (uint256) {
        ...
        uint256 ethPrice = AAVE_ORACLE.getAssetPrice(0x4200000000000000000000000000000000000006); // wETH
            // price in USD
